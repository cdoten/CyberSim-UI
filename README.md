...
CyberSim was originally developed in collaboration with the National Democratic Institute (NDI), with support from Microsoft and the National Endowment for Democracy (NED), as part of broader efforts to strengthen civic resilience in the digital age.

We are grateful for further support from the National Civic League and the Aspen Institute.
